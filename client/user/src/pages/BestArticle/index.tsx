...
import { getBestPostsStart, getBestPostsSuccess, getBestPostsFailure } from "../../features/post/post.slice";
  ...
  useEffect(() => {
    const fetchBestPosts = async () => {
      ...
      try {
        ...
        dispatch(getBestPostsFailure(error.message || "Có lỗi xảy ra khi tải bài viết tốt nhất"));
      }
    };
